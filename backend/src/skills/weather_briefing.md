...
1. User: 「北京今天天气怎么样」→ activate; call `get_weather` for 北京.
2. User: 「要带伞吗」with home city in memory → activate; use remembered city + tool.
3. User: 「帮我写一封邮件」→ should NOT activate (writing_assistant).
